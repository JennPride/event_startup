			    ...
			    <div class="row">
			        <div class="col-md-8 col-md-offset-2">
                      ...
                      <div class="pannel-body">
												Thanks for choosing the Gold Level! Below you can customize the attributes for your
												own personal event page. If you change your mind on anything - don't worry! You can
			                ...
			                <div class="panel-body">
			                    <form class="form-horizontal" role="form" method="POST" action="/submit-payment" id="payment-form">
			                        {{ csrf_field() }}
                              ...
                              <input name="payment_tier" type="hidden" value="Gold">
                              ...
                              <span class="payment-errors"></span>
															...
															<p> Don't worry, we didn't forget you wanted to sell merchandise and tickets! Once you submit your event and
																payment, you'll be able to add/manage merchandise and tickets on your dashboard - in addition to tracking sales
																and providing promotions! </p>
                              <div class="form-row">
                                  <label>

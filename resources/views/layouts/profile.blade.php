          ...
          @else
              <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    @if (Auth::user()->profileType = "Organization")
                      <li><a href="{{ url('/submit-event') }}"><i class="fa fa-bolt"></i> Submit Event</a></li>
                      <li><a href="{{ url('/manage-events') }}"><i class="fa fa-bolt"></i> Manage Your Events</a></li>
                    @endif
